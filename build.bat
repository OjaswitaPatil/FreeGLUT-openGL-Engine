...
for %%f in (OGL.cpp Shape.cpp imGuiExtenstion.cpp LinkedList.cpp imgui\*.cpp) do (
...
link.exe OGL.obj Shape.obj imGuiExtenstion.obj LinkedList.obj imgui\imgui.obj imgui\imgui_demo.obj imgui\imgui_draw.obj imgui\imgui_tables.obj imgui\imgui_widgets.obj imgui\imgui_impl_glut.obj imgui\imgui_impl_opengl2.obj /LIBPATH:C:\freeglut\lib\x64 freeglut.lib opengl32.lib glu32.lib /SUBSYSTEM:CONSOLE
